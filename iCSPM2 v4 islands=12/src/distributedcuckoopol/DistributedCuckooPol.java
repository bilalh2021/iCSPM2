...
public class DistributedCuckooPol {
    ...
    public static void main(String[] args) {
        ...
        int numSubpopulation = 12;  // number of islands
        ...
        for (int i = 0; i < Maxiter / Fm; i++) {
            ...
            CS10 o5 = new CS10(ff, Fm, dimension, N / numSubpopulation, LB, UB);
            result[4] = o5.search();
            if (result[4] < bestOptimizedValue) {
                bestOptimizedValue = result[4];
            }
            CS11 o6 = new CS11(ff, Fm, dimension, N / numSubpopulation, LB, UB);
            result[5] = o6.search();
            if (result[5] < bestOptimizedValue) {
                bestOptimizedValue = result[5];
            }
            CS1 o7 = new CS1(ff, Fm, dimension, N / numSubpopulation, LB, UB);
            result[6] = o7.search();
            ...
            CS10 o9 = new CS10(ff, Fm, dimension, N / numSubpopulation, LB, UB);
            result[8] = o9.search();
            if (result[8] < bestOptimizedValue) {
                bestOptimizedValue = result[8];
            }
           CS11 o10 = new CS11(ff, Fm, dimension, N / numSubpopulation, LB, UB);
            result[8] = o9.search();
            if (result[8] < bestOptimizedValue) {
                bestOptimizedValue = result[8];
            }
            CS1 o11 = new CS1(ff, Fm, dimension, N / numSubpopulation, LB, UB);
            result[8] = o9.search();
            if (result[8] < bestOptimizedValue) {
                bestOptimizedValue = result[8];
            }
            CSJ o12 = new CSJ(ff, Fm, dimension, N / numSubpopulation, LB, UB);
            result[8] = o9.search();
            if (result[8] < bestOptimizedValue) {
                bestOptimizedValue = result[8];
            }
            ...
            if (i % 10 == 0 || i % 10 == 1) {
                o12.replaceWorst(o1.migrateBest(numberofMigrants));
                o11.replaceWorst(o12.migrateBest(numberofMigrants));
                o10.replaceWorst(o11.migrateBest(numberofMigrants));
                o2.replaceWorst(o10.migrateBest(numberofMigrants));
                ...
                o8.replaceWorst(o7.migrateBest(numberofMigrants));
                o9.replaceWorst(o8.migrateBest(numberofMigrants));
                o7.replaceWorst(o9.migrateBest(numberofMigrants));
                o1.replaceWorst(o7.migrateBest(numberofMigrants));
            } else if (i % 10 == 02 || i % 10 == 3) {
                o12.replaceWorst(o1.migrateBest(numberofMigrants));
                o3.replaceWorst(o12.migrateBest(numberofMigrants));
                o11.replaceWorst(o3.migrateBest(numberofMigrants));
                o10.replaceWorst(o11.migrateBest(numberofMigrants));
                o5.replaceWorst(o10.migrateBest(numberofMigrants));
                ...
                o9.replaceWorst(o2.migrateBest(numberofMigrants));
                o1.replaceWorst(o9.migrateBest(numberofMigrants));
            } else if (i % 10 == 4 || i % 10 == 5) {
                 o12.replaceWorst(o9.migrateBest(numberofMigrants));
                o11.replaceWorst(o12.migrateBest(numberofMigrants));
                o10.replaceWorst(o11.migrateBest(numberofMigrants));
                o1.replaceWorst(o10.migrateBest(numberofMigrants));
                ...
                o7.replaceWorst(o8.migrateBest(numberofMigrants));
                o9.replaceWorst(o7.migrateBest(numberofMigrants));
            } else {
                 o12.replaceWorst(o6.migrateBest(numberofMigrants));
                o11.replaceWorst(o12.migrateBest(numberofMigrants));
                o10.replaceWorst(o11.migrateBest(numberofMigrants));
                o5.replaceWorst(o10.migrateBest(numberofMigrants));
                ...
                o2.replaceWorst(o7.migrateBest(numberofMigrants));
                o9.replaceWorst(o2.migrateBest(numberofMigrants));
                o8.replaceWorst(o9.migrateBest(numberofMigrants));
